...
export const scenes: Record<string, SceneDefinition> = {
  ...
  'swamp-deep': {
    ...
    enemies: [
      { id: 'sd-ghost-1', type: 'ghost', visual: '', patrolStart: 33, patrolEnd: 78, y: 84, speed: 10, width: 5, height: 10 },
      { id: 'sd-bat-1', type: 'bat', visual: '', patrolStart: 88, patrolEnd: 123, y: 70, speed: 9, width: 4, height: 5 },
      { id: 'sd-skeleton-1', type: 'skeleton', visual: '', patrolStart: 87, patrolEnd: 124, y: 84, speed: 11, width: 5, height: 8 },
    ],
    platforms: [
  ...
  'church-meeting': {
    ...
    collectibles: [
      ...
      { id: 'cm-gem-1', visual: 'gem', x: 175, y: 58, label: '+$800', resourceBonus: { money: 800 }, flavorText: '"A reward for the bold."' },
    ],
    obstacles: [
    ...
    enemies: [
      ...
      { id: 'cm-bat-1', type: 'bat', visual: '', patrolStart: 152, patrolEnd: 213, y: 74, speed: 24, width: 4, height: 5 },
    ],
    platforms: [
      ...
      { id: 'cm-plat-3', x: 170, y: 62, width: 6, visual: 'stone' },
    ],
  },
  ...
  'castle-hall': {
    ...
    levelWidth: 300,
    playerStartX: 6,
    ambientColor: 'sepia(0.15) brightness(0.85)',
    groundSegments: [
      { startX: 195, endX: 230, groundY: 76 },
      { startX: 230, endX: 270, groundY: 72 },
      { startX: 270, endX: 300, groundY: 68 },
    ],
    groundHoles: [
      { id: 'ch-hole-1', startX: 58, endX: 63 },
      { id: 'ch-hole-2', startX: 115, endX: 121 },
      { id: 'ch-hole-3', startX: 168, endX: 174 },
    ],
    interactables: [
      {
        id: 'investor-npc',
    ...
    collectibles: [
      { id: 'ch-coin-1', visual: 'coin', x: 42, y: 66, label: '+$500', resourceBonus: { money: 500 }, flavorText: '"Seed money stash."' },
      { id: 'ch-gem-1', visual: 'gem', x: 140, y: 57, label: '+$1500', resourceBonus: { money: 1500 }, flavorText: '"Angel investment!"' },
      { id: 'ch-coffee-1', visual: 'coffee', x: 180, label: '+10 Energy', resourceBonus: { energy: 10 }, flavorText: '"Pitch-day espresso."' },
      { id: 'ch-usb-1', visual: 'usb', x: 250, y: 55, label: '+20 Rep', resourceBonus: { reputation: 20 }, flavorText: '"Portfolio on a thumb drive."' },
      { id: 'ch-doc-1', visual: 'document', x: 295, y: 68, label: 'Term Sheet', flavorText: '"Pre-money valuation: $2M"' },
    ],
    obstacles: [
      ...
      { id: 'ch-barrel-2', type: 'barrel', x: 100, width: 5, height: 10 },
      { id: 'ch-crate-2', type: 'crate', x: 155, width: 6, height: 11 },
      { id: 'ch-rock-2', type: 'rock', x: 210, width: 6, height: 9 },
      { id: 'ch-grave-1', type: 'grave', x: 260, width: 5, height: 10 },
    ],
    enemies: [
      { id: 'ch-skeleton-1', type: 'skeleton', visual: '', patrolStart: 28, patrolEnd: 43, y: 80, speed: 13, width: 4, height: 14 },
      { id: 'ch-thorn-1', type: 'thorn-bush', visual: '', patrolStart: 82, patrolEnd: 82, y: 80, speed: 0, width: 5, height: 8 },
      { id: 'ch-ghost-2', type: 'ghost', visual: '', patrolStart: 88, patrolEnd: 97, y: 80, speed: 10, width: 5, height: 10 },
      { id: 'ch-ghost-3', type: 'ghost', visual: '', patrolStart: 104, patrolEnd: 113, y: 80, speed: 10, width: 5, height: 10 },
      { id: 'ch-ghost-1', type: 'ghost', visual: '', patrolStart: 125, patrolEnd: 160, y: 80, speed: 12, width: 5, height: 10 },
      { id: 'ch-bat-1', type: 'bat', visual: '', patrolStart: 235, patrolEnd: 268, y: 72, speed: 22, width: 4, height: 5 },
    ],
    platforms: [
      { id: 'ch-plat-1', x: 38, y: 68, width: 8, visual: 'stone' },
      { id: 'ch-plat-2', x: 78, y: 68, width: 6, visual: 'stone' },
      { id: 'ch-plat-3', x: 130, y: 65, width: 10, visual: 'metal' },
      { id: 'ch-plat-move', x: 145, y: 58, width: 8, visual: 'metal', moveAxis: 'horizontal', moveRange: 12, moveSpeed: 0.5 },
      { id: 'ch-plat-4', x: 245, y: 58, width: 6, visual: 'stone' },
      { id: 'ch-plat-grave', x: 258, y: 62, width: 7, visual: 'stone' },
    ],
    challenge: {
